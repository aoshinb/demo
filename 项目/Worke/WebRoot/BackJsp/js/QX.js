...
layui.use('table', function(){*/
	...
	var tableIns = table.render({
		elem: '#test'
			,url:'http://localhost:8080/Worke/Servlet?action=seleALLQX'
	...
	,title: '权限数据表'
		,cols: [[
			...
			{field: 'qxname', title: 'QXNAME', minWidth:100, align:"center"},
			{field: 'btn', title: 'BTN',  align:'center'},
			{field: 'type', title: 'TYPE', minWidth:150, align:'center'},
			{field: 'url', title: 'URL', align:'center'},
			{field: 'function', title: 'FUNCTION', align:'center'}
			]]
	,page: true
	});
